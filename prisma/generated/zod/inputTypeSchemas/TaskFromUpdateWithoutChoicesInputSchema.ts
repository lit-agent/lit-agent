...
import { MessageUpdateManyWithoutTaskNestedInputSchema } from './MessageUpdateManyWithoutTaskNestedInputSchema';
...
export const TaskFromUpdateWithoutChoicesInputSchema: z.ZodType<Prisma.TaskFromUpdateWithoutChoicesInput> = z.object({
  ...
  messages: z.lazy(() => MessageUpdateManyWithoutTaskNestedInputSchema).optional()
}).strict();

export default TaskFromUpdateWithoutChoicesInputSchema;
